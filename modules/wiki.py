...
def new_queue_page(data,r,awardee,token_comment):
  ...
  add_content = "|/u/%s|[Link](%s)| [Approve](/message/compose/?to=%s&subject=%s&message=%s) / [Reject](/message/compose/?to=%s&subject=%s&message=%s) |" % 
    (awardee,token_comment.permalink + "?context=2",data["running_username"],"approve",token_comment.permalink,
